...
with TemporaryDirectory() as td:
    ...
    expected_indexes = {
        ...
        'idx_staff_role_id', 'idx_document_locks_contract_id', 'idx_contracts_revision', 'ux_contracts_merge_uid', 'ux_systems_merge_uid', 'ux_deliveries_merge_uid', 'ux_contract_file_folders_merge_uid', 'ux_contract_files_merge_uid',
    }
