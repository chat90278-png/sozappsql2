...
with TemporaryDirectory() as td:
    ...
    expected_columns = {
        ...
        'staff_agenda_state': {'staff_id', 'agenda_key', 'first_presented_at', 'last_presented_at', 'seen_at', 'seen_version', 'snoozed_until', 'snoozed_version', 'snoozed_severity', 'dismissed_at', 'dismissed_version', 'created_at', 'updated_at'},
    }
    ...
    expected_indexes = {
        ...
        'idx_staff_role_id', 'idx_document_locks_contract_id', 'idx_contracts_revision', 'idx_share_packages_contract_merge_uid', 'idx_share_packages_contract_status', 'idx_share_packages_created_at', 'ux_contracts_merge_uid', 'ux_systems_merge_uid', 'ux_deliveries_merge_uid', 'ux_contract_file_folders_merge_uid', 'ux_contract_files_merge_uid', 'idx_staff_agenda_state_staff', 'idx_staff_agenda_state_snoozed',
    }
