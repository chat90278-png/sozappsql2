...
def test_real_v18_without_agenda_state_upgrades_to_v19(tmp_path: Path):
    ...
    assert result.applied_migrations == ("v18_to_v19_staff_agenda_state",)
    assert read_sts_schema_version(path) == CURRENT_SCHEMA_VERSION == 19
