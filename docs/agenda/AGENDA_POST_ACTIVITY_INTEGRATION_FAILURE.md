# Gündemim Post-Activity Integration Failure

- target_base_head: `f9ea2b930faaf0aa9d9cf6bb0d6e86c05eb15128`
...
M  tests/test_activity_history_main_integration.py
M  tests/test_activity_history_operations.py
M  tests/test_activity_history_query.py
...
Downloading pyside6-6.11.1-cp310-abi3-win_amd64.whl (578 kB)
   ---------------------------------------- 578.4/578.4 kB 21.1 MB/s  0:00:00
...
Downloading pyside6_addons-6.11.1-cp310-abi3-win_amd64.whl (168.8 MB)
   ---------------------------------------- 168.8/168.8 MB 54.5 MB/s  0:00:03
...
.....................                                                    [100%]
================================== FAILURES ===================================
__ test_activity_schema_migration_is_additive_idempotent_and_preserves_rows ___

tmp_path = WindowsPath('C:/Users/runneradmin/AppData/Local/Temp/pytest-of-runneradmin/pytest-1/test_activity_schema_migration0')
...
tests\test_activity_history_infrastructure.py:84: AssertionError
_________ test_activity_behavior_is_defined_directly_in_source_files __________
...
E       assert 'CURRENT_SCHEMA_VERSION = 18' in 'from __future__ import annotations\nimport json\nimport logging\nimport sqlite3\nimport platform as platform_module\n..."activity_log_count": int(counts.get("activity_logs", 0)),\n            "recent_metrics": recent_metrics,\n        }\n'

tests\test_activity_history_infrastructure.py:332: AssertionError
=========================== short test summary info ===========================
FAILED tests/test_activity_history_infrastructure.py::test_activity_schema_migration_is_additive_idempotent_and_preserves_rows - AssertionError: assert 19 == 18
 +  where 19 = int('19')
FAILED tests/test_activity_history_infrastructure.py::test_activity_behavior_is_defined_directly_in_source_files - assert 'CURRENT_SCHEMA_VERSION = 18' in 'from __future__ import annotations\nimport json\nimport logging\nimport sqlite3\nimport platform as platform_module\n..."activity_log_count": int(counts.get("activity_logs", 0)),\n            "recent_metrics": recent_metrics,\n        }\n'
2 failed, 1315 passed in 129.51s (0:02:09)
```
