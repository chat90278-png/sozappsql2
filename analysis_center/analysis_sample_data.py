...
def build_sample_data(today: date | None = None) -> NormalizedAnalysisData:
    ...
    health_items = [
        {"entity": "contract", "platform": "KIZILELMA", "contract_no": "STS-2026-003", "field": "user", "label": "Eksik kullanıcı bilgisi"},
        {"entity": "contract", "platform": "KIZILELMA", "contract_no": "STS-2026-003", "field": "tags", "label": "Etiketsiz kayıt"},
    ]
    return {"contracts": contracts, "platforms": platforms, "acceptances": acceptances, "deadlines": deadlines, "systems": systems, "components": components, "users": users, "tags": tags, "health_items": health_items}
