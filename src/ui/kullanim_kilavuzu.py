...
GUIDE_SECTIONS = [
    ...
    },
    {
        ...
        "purpose": "Sistem kayıtlarında kullanılacak bileşen kalemlerini standartlaştırır ve teslimat miktarlarının aynı adlarla takip edilmesini sağlar.",
        "actions": [
    ...
    },
    {
        ...
        "purpose": "Seçilen sözleşmenin tüm meta bilgilerini, etiketlerini, sistemlerini ve teslimat kayıtlarını düzenlemek için kullanılır.",
        "actions": [
            ...
            "Teslimat alanında manuel teslimat ekleyebilir veya sistem bilgisine göre otomatik teslimat üretebilirsiniz.",
    ...
    },
    {
        ...
        "purpose": "Sözleşmeye bağlı sistemleri, sistem durumlarını, termin/teslimat bilgilerini ve sistem bileşen miktarlarını yönetir.",
        "actions": [
            "Sistem Yönetimi bölümündeki Yeni Sistem Ekle butonuyla yeni sistem kaydı oluşturabilirsiniz.",
            "Düzenle butonuyla seçili sistemin adı, durum, termin, teslimat tarihi ve açıklama alanlarını güncelleyebilirsiniz.",
            "Bileşen satırlarında teslim edilecek miktarları girerek teslimat takibini hazırlayabilirsiniz.",
    ...
    {
        "title": "Teslimat Ekleme",
        "icon": "✅",
        "parent": "Sözleşme Detay Ekranı",
        "image": "kabul_ekleme.png",
        "purpose": "Teslim edilen sistem veya bileşenler için manuel teslimat kaydı oluşturmak ya da sistem bilgilerine göre teslimat sürecini güncellemek için kullanılır.",
        "actions": [
            "Teslimat alanındaki Teslimat Ekle veya Manuel Teslimat Ekle butonuyla kayıt penceresini açabilirsiniz.",
            "Teslimat tarihi, teslimat no/tutanak bilgisi, ilgili sistem ve açıklama alanlarını doldurabilirsiniz.",
            "Bileşen bazlı miktar girilebiliyorsa teslim edilen miktarları ilgili satırlara yazabilirsiniz.",
            "Kaydet/Ekle ile teslimat kaydını listeye ekleyebilir, İptal/Kapat ile vazgeçebilirsiniz.",
            "Teslimat sonrası sistem durumu ve kalan bileşen miktarlarını detay/özet ekranlarından kontrol edebilirsiniz.",
        ],
        "tip": "Teslimat tarihini ve miktarları doğru girmek, gecikme ve kalan teslimat uyarılarının doğru çalışmasını sağlar.",
    },
    {
    ...
    },
    {
        ...
        "icon": "📊",
        "image": "ozet.png",
        "purpose": "Seçilen sözleşme ailesinin durumunu, sistem sayılarını, teslimat metriklerini ve bileşen durumunu tek ekranda özetler.",
        "actions": [
            "Ana sözleşme ve alt sözleşme kapsamını Tür alanından daraltabilir veya tüm aileyi birlikte inceleyebilirsiniz.",
            "Sözleşmeler/Sistem Bilgisi panelinden durum, termin, teslimat tarihi ve sistem sayılarını kontrol edebilirsiniz.",
            "Bileşen Durumu panelinde teslim edilecek, teslim edilen ve kalan bileşen miktarlarını görebilirsiniz.",
            "Üst metrik kartları ile toplam sistem, teslimat ve durum dağılımlarını hızlıca okuyabilirsiniz.",
        ],
